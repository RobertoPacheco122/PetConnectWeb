        ...
        <section className="flex gap-8 mb-16">
          ...
          <div className="w-[500px]">
            ...
            <span className="text-sm block mb-4">
              ...
              sagittis luctus libero, nec porttitor urna molestie eget. Praesent
              nec laoreet mi. Lorem ipsum dolor sit amet, consectetur adipiscing
              elit.
            </span>
                  ...
                  <li key={index} className="mb-8">
                    ...
                    <div>
                      ...
                      <p className="mb-2">
                        ...
                        Quisque laoreet condimentum felis, ac facilisis tellus
                        rutrum a. Quisque sagittis luctus libero, nec porttitor
                        urna molestie eget. Praesent nec laoreet mi. Lorem ipsum
